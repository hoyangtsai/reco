...
class InitCommand extends Command {
  ...
  * installPkgDeps(targetDir) {
    return yield helper.spawn('npm', ['install'], {
      cwd: targetDir,
      stdio: 'inherit',
    });
  }
  ...
  * downloadBoilerplate(pkgName) {
    const pkgInfo = yield helper.getPackageInfo(this.registryUrl, pkgName, false, this.log);
  ...
  * fetchBoilerplateMapping(pkgName) {
    const pkgInfo = yield helper.getPackageInfo(this.registryUrl, pkgName || this.configName, true, this.log);
